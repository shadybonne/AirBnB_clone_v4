# automatic the configuration of Nginx server with some folders and files
...
exec {'content into html':
  provider => shell,
  command  => 'echo "Welcome to my site!" | sudo tee /data/web_static/releases/test/index.html',
